...
const PostDetails = () => {
  ...
  return (
    <div className="">
        <Navbar/>
        {loader?<div className="h-[80vh] flex justify-center items-center w-full"><Loader/></div>:<div className="px-8 md:px-[400px] mt-8 ">
       ...
       <p>{new Date(post.updatedAt).toString().slice(16,21)}</p>
        ...
        <img src={IF+post.photo} className="w-full  mx-auto mt-8" alt=""/>
         <p className="mx-auto mt-8 bg-slate-100 px-3 py-3 rounded-xl">{post.desc}</p>
