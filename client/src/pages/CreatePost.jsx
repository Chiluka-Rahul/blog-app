...
const CreatePost = () => {
  ...
  return (
    <div>
        ...
        <h1 className='font-bold md:text-2xl text-xl px-2'>Create a post</h1>
        <form className='w-full flex flex-col space-y-4 md:space-y-8 mt-4'>
          ...
          <div className='flex flex-col'>
            <div className='flex items-center space-x-4 md:space-x-8'>
                ...
                <div onClick={addCategory} className='bg-black text-white px-4 py-2 font-semibold cursor-pointer rounded'>Add</div>
            </div>
